...
<body class="easyui-layout">
    ...
    <div region="west" style="width: 200px" title="导航菜单" split="true">
        ...
        <div id="aa" class="easyui-accordion" style="width:200px;height:auto;">
            ...
            <div title="博客类别管理" data-options="iconCls:'icon-bklb'" style="padding:10px">
                <a href="javascript:openTab('博客类别信息管理','blogtype.jsp','icon-bklb')" class="easyui-linkbutton"
    ...
    <div data-options="region:'center'" style="background:#eee;">
        ...
        <div id="tabs" class="easyui-tabs" fit="true" style="text-align: center">
            <div align="center" id="title" title="Index" style="padding: 20px;text-align: center;">主页</div>
        </div>
    </div>



    <div region="south" style="height: 25px;padding: 5px" align="center" class="footer">
        Copyright © 2012-2017 任晓天的SSM博客系统 版权所有
    </div>
</body>
<script>
    $(document).ready(function () {
        console.info("$(document).ready");
        $('#blogCat_btn').click(function () {
            addTab("内嵌jsp",'http://localhost:8080/add');
        });

        $('#blogContent_btn').click(function () {
            addTab('内容管理TAB', 'http://www.runoob.com/jeasyui/jeasyui-layout-tabs2.html');
        });

        $('#userSetting_btn').click(function () {
            addTab('个人设置TAB', 'http://www.runoob.com/jeasyui/jeasyui-layout-tabs2.html');
        });
